...
gulp.task('scripts', function(){
	return gulp.src(['./client/js/app.js', './client/js/caisse.js', './client/js/admin_panel_gerer_caisse.js', './client/js/admin_panel_gerer_categorie.js', './client/js/admin_journaldesventes.js'])
		.pipe(plumber())
